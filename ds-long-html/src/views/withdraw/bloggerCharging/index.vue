    ...
    return {
      ...
      searchHandle: [
        ...
        },
        {
          ...
          // label: "导出",
          type: "success",
          auth: () => this.permissions.sys_withdraw_blogger_charging_export,
          callback: () => {
            ...
            withdrawExport(params).then((res) => {
              if (res.status == 200) {
                downloadExcel(res.data, `充电博主提现列表`);
              }
            });
          },
        },
      ...
      tableLabel: [
        ...
        },
        {
          ...
          html: (row) => {
            ...
            if (
              row.status === EnumWithdrawStatus.pending &&
              this.permissions.sys_withdraw_blogger_charging_audit
            ) {
              return audit;
