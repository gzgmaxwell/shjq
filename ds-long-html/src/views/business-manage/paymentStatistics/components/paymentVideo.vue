...
<script>
import { gotoBuyVideoStatistics } from "@/api/admin/index";
  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        {
          label: "购买金额",
          prop: "videoConsumeAmount",
        },
        {
          label: "视频购买次数",
          type: "html",
          html: (row) => {
            return `<span class="link">${row.videoConsumeCount}</span>`;
          },
          callback: (row) => {
            this.visible = true;
            this.row = {
