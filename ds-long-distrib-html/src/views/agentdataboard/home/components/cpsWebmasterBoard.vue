        ...
        <el-card shadow="always" class="mt3" style="height: 140px">
          <div class="cardBox">
            <div>
              ...
              <span class="number">
                {{ Number(userTotalData?.newUserCount || 0).toLocaleString() }}
            ...
            <div>
              ...
              <span class="number">
                {{ Number(userTotalData?.androidNewUserCount || 0).toLocaleString() }}
                <span class="union">人</span>
              </span>
            </div>
            <div>
              ...
              <span class="number">
                {{ Number(userTotalData?.iosNewUserCount || 0).toLocaleString() }}
                <span class="union">人</span>
              </span>
            </div>
            <div>
              ...
              <span class="number">
                {{ Number(userTotalData?.unknownNewUserCount || 0).toLocaleString() }}
                <span class="union">人</span>
              </span>
            </div>
          </div>
        ...
        <el-card shadow="always" class="mt3" style="height: 140px">
          <div class="cardBox">
            <div>
              ...
              <span class="number">
                {{ Number(totalData?.totalAmount || 0).toLocaleString() }}
            ...
            <div>
              <span class="title">Android</span>
              <span class="number">
                {{ Number(totalData?.androidTotalAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">IOS</span>
              <span class="number">
                {{ Number(totalData?.iosTotalAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">未知</span>
              <span class="number">
                {{ Number(totalData?.unknownTotalAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
          </div>
        ...
        <el-card shadow="always" class="mt3" style="height: 140px">
          <div class="cardBox">
            <div>
              ...
              <span class="number">
                {{ Number(totalData?.rechargeAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">Android</span>
              <span class="number">
                {{ Number(totalData?.androidRechargeAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">IOS</span>
              <span class="number">
                {{ Number(totalData?.iosRechargeAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">未知</span>
              <span class="number">
                {{ Number(totalData?.unknownRechargeAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
          </div>
        ...
        <el-card shadow="always" class="mt3" style="height: 140px">
          <div class="cardBox">
            <div>
              ...
              <span class="number">
                {{ Number(totalData?.svipAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">Android</span>
              <span class="number">
                {{ Number(totalData?.androidSvipAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">IOS</span>
              <span class="number">
                {{ Number(totalData?.iosSvipAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
            <div>
              <span class="title">未知</span>
              <span class="number">
                {{ Number(totalData?.unknownSvipAmount || 0).toLocaleString() }}
                <span class="union">¥</span>
              </span>
            </div>
          </div>
...
import { webmasterDashboardRecharge, webmasterDashboardNewUser } from "@/api/system";
import moment from "moment";
import { optLong } from "@/enums";
import { filterNullSearchData } from "@/utils/index";

// const userStore: any = useUserStore();
const userTotalData: any = ref({});
...
const getDataList = () => {
  ...
  webmasterDashboardRecharge(params).then((res) => {
...
const getAddUserData = () => {
  ...
  webmasterDashboardNewUser(params).then((res) => {
    userTotalData.value = res.data.data;
  });
};
const reset = () => {
  busPlatformId.value = "";
